...
LD_LIBRARY_PATH=/usr/lib/llvm-3.4/lib/ $BINDGEN_DIR/bindgen ppapi.hpp -I $NACL_INCLUDE_DIR -match ppapi/c -match nacl_io -match sys/mount -match ppapi.hpp >> $OUT
...
echo "#[cfg(target_os = \"nacl\")] #[link(name = \"ppapi\")] extern {}" \
    >> $OUT
