...
pub type PPB_GetInterface = extern "C" fn(arg1: *::libc::c_char) -> *::libc::c_void;
...
pub type PP_GetInterface_Func =
    ::std::option::Option<extern "C" fn(arg1: *::libc::c_char)
                              -> *::libc::c_void>;
...
pub type PP_CompletionCallback_Func = extern "C" fn(arg1: *mut ::libc::c_void, arg2: int32_t);
...
pub type nacl_io_exit_handler_t =
    ::std::option::Option<extern "C" fn
                              (arg1: ::libc::c_int,
                               arg2: *mut ::libc::c_void)>;
pub type Struct_fuse_operations = ::libc::c_void;
pub type Enum_Unnamed3 = ::libc::c_int;
pub static MS_RDONLY: ::libc::c_int = 1;
pub static MS_NOSUID: ::libc::c_int = 2;
pub static MS_NODEV: ::libc::c_int = 4;
pub static MS_NOEXEC: ::libc::c_int = 8;
pub static MS_SYNCHRONOUS: ::libc::c_int = 16;
pub static MS_REMOUNT: ::libc::c_int = 32;
pub static MS_MANDLOCK: ::libc::c_int = 64;
pub static MS_DIRSYNC: ::libc::c_int = 128;
pub static MS_NOATIME: ::libc::c_int = 1024;
pub static MS_NODIRATIME: ::libc::c_int = 2048;
pub static MS_BIND: ::libc::c_int = 4096;
pub static MS_MOVE: ::libc::c_int = 8192;
pub static MS_REC: ::libc::c_int = 16384;
pub static MS_SILENT: ::libc::c_int = 32768;
pub static MS_POSIXACL: ::libc::c_int = 65536;
pub static MS_UNBINDABLE: ::libc::c_int = 131072;
pub static MS_PRIVATE: ::libc::c_int = 262144;
pub static MS_SLAVE: ::libc::c_int = 524288;
pub static MS_SHARED: ::libc::c_int = 1048576;
pub static MS_RELATIME: ::libc::c_int = 2097152;
pub static MS_KERNMOUNT: ::libc::c_int = 4194304;
pub static MS_I_VERSION: ::libc::c_int = 8388608;
pub static MS_STRICTATIME: ::libc::c_int = 16777216;
pub static MS_ACTIVE: ::libc::c_int = 1073741824;
pub static MS_NOUSER: ::libc::c_int = -2147483648;
pub type Enum_Unnamed4 = ::libc::c_uint;
pub static MNT_FORCE: ::libc::c_uint = 1;
pub static MNT_DETACH: ::libc::c_uint = 2;
pub static MNT_EXPIRE: ::libc::c_uint = 4;
pub static UMOUNT_NOFOLLOW: ::libc::c_uint = 8;
extern "C" {
    pub fn PPP_InitializeModule(module: PP_Module,
                                get_browser_interface: PPB_GetInterface) ->
     int32_t;
    pub fn PPP_ShutdownModule();
    pub fn PPP_GetInterface(interface_name: *::libc::c_char) -> *::libc::c_void;
    pub fn nacl_io_init();
    pub fn nacl_io_init_ppapi(instance: PP_Instance,
                              get_interface: PPB_GetInterface);
    pub fn nacl_io_register_exit_handler(exit_handler: nacl_io_exit_handler_t,
                                         user_data: *mut ::libc::c_void) ->
     ::libc::c_int;
    pub fn nacl_io_register_fs_type(fs_type: *::libc::c_char,
                                    fuse_ops: *mut Struct_fuse_operations) ->
     ::libc::c_int;
    pub fn nacl_io_unregister_fs_type(fs_type: *::libc::c_char) ->
     ::libc::c_int;
    pub fn mount(__special_file: *::libc::c_char, __dir: *::libc::c_char,
                 __fstype: *::libc::c_char, __rwflag: ::libc::c_ulong,
                 __data: *::libc::c_void) -> ::libc::c_int;
    pub fn umount(__special_file: *::libc::c_char) -> ::libc::c_int;
    pub fn umount2(__special_file: *::libc::c_char, __flags: ::libc::c_int) ->
     ::libc::c_int;
    ...
    pub fn string_id_to_var(id: i64) -> Struct_PP_Var;
