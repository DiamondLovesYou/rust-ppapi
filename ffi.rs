...
extern "C" {
    pub static mut _impure_ptr: *mut Struct__reent;
    pub static _global_impure_ptr: *mut Struct__reent;
    ...
    pub fn PPP_GetInterface(interface_name: *const ::libc::c_char) ->
     *const ::libc::c_void;
    pub fn PP_FromBool(b: ::libc::c_int) -> PP_Bool;
    pub fn PP_ToBool(b: PP_Bool) -> ::libc::c_int;
    pub fn PP_MakeUndefined() -> Struct_PP_Var;
    pub fn PP_MakeNull() -> Struct_PP_Var;
    pub fn PP_MakeBool(value: PP_Bool) -> Struct_PP_Var;
    pub fn PP_MakeInt32(value: int32_t) -> Struct_PP_Var;
    pub fn PP_MakeDouble(value: ::libc::c_double) -> Struct_PP_Var;
    pub fn __local_lock_init(lock: *mut _LOCK_T);
    pub fn __local_lock_init_recursive(lock: *mut _LOCK_T);
    pub fn __local_lock_close(lock: *mut _LOCK_T);
    pub fn __local_lock_close_recursive(lock: *mut _LOCK_T);
    pub fn __local_lock_acquire(lock: *mut _LOCK_T);
    pub fn __local_lock_acquire_recursive(lock: *mut _LOCK_T);
    pub fn __local_lock_try_acquire(lock: *mut _LOCK_T) -> ::libc::c_int;
    pub fn __local_lock_try_acquire_recursive(lock: *mut _LOCK_T) ->
     ::libc::c_int;
    pub fn __local_lock_release(lock: *mut _LOCK_T);
    pub fn __local_lock_release_recursive(lock: *mut _LOCK_T);
    pub fn _reclaim_reent(arg1: *mut Struct__reent);
    ...
    pub fn atoff(__nptr: *const ::libc::c_char) -> ::libc::c_float;
    pub fn atoi(__nptr: *const ::libc::c_char) -> ::libc::c_int;
    pub fn _atoi_r(arg1: *mut Struct__reent, __nptr: *const ::libc::c_char) ->
     ::libc::c_int;
    pub fn atol(__nptr: *const ::libc::c_char) -> ::libc::c_long;
    pub fn _atol_r(arg1: *mut Struct__reent, __nptr: *const ::libc::c_char) ->
     ::libc::c_long;
    pub fn bsearch(__key: *const ::libc::c_void,
                   __base: *const ::libc::c_void, __nmemb: size_t,
                   __size: size_t, _compar: __compar_fn_t) ->
     *mut ::libc::c_void;
    ...
    pub fn _getenv_r(arg1: *mut Struct__reent,
                     __string: *const ::libc::c_char) -> *mut ::libc::c_char;
    pub fn _findenv(arg1: *const ::libc::c_char, arg2: *mut ::libc::c_int) ->
     *mut ::libc::c_char;
    pub fn _findenv_r(arg1: *mut Struct__reent, arg2: *const ::libc::c_char,
    ...
    pub fn _mblen_r(arg1: *mut Struct__reent, arg2: *const ::libc::c_char,
                    arg3: size_t, arg4: *mut _mbstate_t) -> ::libc::c_int;
    pub fn mbtowc(arg1: *mut ::libc::c_void, arg2: *const ::libc::c_char,
                  arg3: size_t) -> ::libc::c_int;
    pub fn _mbtowc_r(arg1: *mut Struct__reent, arg2: *mut ::libc::c_void,
                     arg3: *const ::libc::c_char, arg4: size_t,
                     arg5: *mut _mbstate_t) -> ::libc::c_int;
    pub fn wctomb(arg1: *mut ::libc::c_char, arg2: ::libc::c_void) ->
     ::libc::c_int;
    pub fn _wctomb_r(arg1: *mut Struct__reent, arg2: *mut ::libc::c_char,
                     arg3: ::libc::c_void, arg4: *mut _mbstate_t) ->
     ::libc::c_int;
    pub fn mbstowcs(arg1: *mut ::libc::c_void, arg2: *const ::libc::c_char,
                    arg3: size_t) -> size_t;
    pub fn _mbstowcs_r(arg1: *mut Struct__reent, arg2: *mut ::libc::c_void,
                       arg3: *const ::libc::c_char, arg4: size_t,
                       arg5: *mut _mbstate_t) -> size_t;
    pub fn wcstombs(arg1: *mut ::libc::c_char, arg2: *const ::libc::c_void,
                    arg3: size_t) -> size_t;
    pub fn _wcstombs_r(arg1: *mut Struct__reent, arg2: *mut ::libc::c_char,
                       arg3: *const ::libc::c_void, arg4: size_t,
                       arg5: *mut _mbstate_t) -> size_t;
    pub fn mkdtemp(arg1: *mut ::libc::c_char) -> *mut ::libc::c_char;
    pub fn mkostemp(arg1: *mut ::libc::c_char, arg2: ::libc::c_int) ->
     ::libc::c_int;
    pub fn mkostemps(arg1: *mut ::libc::c_char, arg2: ::libc::c_int,
    ...
    pub fn _mkdtemp_r(arg1: *mut Struct__reent, arg2: *mut ::libc::c_char) ->
     *mut ::libc::c_char;
    pub fn _mkostemp_r(arg1: *mut Struct__reent, arg2: *mut ::libc::c_char,
                       arg3: ::libc::c_int) -> ::libc::c_int;
    pub fn _mkostemps_r(arg1: *mut Struct__reent, arg2: *mut ::libc::c_char,
                        arg3: ::libc::c_int, arg4: ::libc::c_int) ->
     ::libc::c_int;
    pub fn _mkstemp_r(arg1: *mut Struct__reent, arg2: *mut ::libc::c_char) ->
     ::libc::c_int;
    pub fn _mkstemps_r(arg1: *mut Struct__reent, arg2: *mut ::libc::c_char,
                       arg3: ::libc::c_int) -> ::libc::c_int;
    pub fn _mktemp_r(arg1: *mut Struct__reent, arg2: *mut ::libc::c_char) ->
     *mut ::libc::c_char;
    pub fn qsort(__base: *mut ::libc::c_void, __nmemb: size_t, __size: size_t,
                 _compar: __compar_fn_t);
    pub fn rand() -> ::libc::c_int;
    pub fn realloc(__r: *mut ::libc::c_void, __size: size_t) ->
     *mut ::libc::c_void;
    pub fn reallocf(__r: *mut ::libc::c_void, __size: size_t) ->
     *mut ::libc::c_void;
    pub fn realpath(path: *const ::libc::c_char,
                    resolved_path: *mut ::libc::c_char) ->
     *mut ::libc::c_char;
    pub fn srand(__seed: ::libc::c_uint);
    pub fn strtod(__n: *const ::libc::c_char,
                  __end_PTR: *mut *mut ::libc::c_char) -> ::libc::c_double;
    pub fn _strtod_r(arg1: *mut Struct__reent, __n: *const ::libc::c_char,
                     __end_PTR: *mut *mut ::libc::c_char) -> ::libc::c_double;
    pub fn strtof(__n: *const ::libc::c_char,
                  __end_PTR: *mut *mut ::libc::c_char) -> ::libc::c_float;
    pub fn strtol(__n: *const ::libc::c_char,
                  __end_PTR: *mut *mut ::libc::c_char, __base: ::libc::c_int)
     -> ::libc::c_long;
    pub fn _strtol_r(arg1: *mut Struct__reent, __n: *const ::libc::c_char,
                     __end_PTR: *mut *mut ::libc::c_char,
                     __base: ::libc::c_int) -> ::libc::c_long;
    pub fn strtoul(__n: *const ::libc::c_char,
                   __end_PTR: *mut *mut ::libc::c_char, __base: ::libc::c_int)
     -> ::libc::c_ulong;
    pub fn _strtoul_r(arg1: *mut Struct__reent, __n: *const ::libc::c_char,
                      __end_PTR: *mut *mut ::libc::c_char,
    ...
    pub fn _l64a_r(arg1: *mut Struct__reent, __input: ::libc::c_long) ->
     *mut ::libc::c_char;
    ...
    pub fn _putenv_r(arg1: *mut Struct__reent, __string: *mut ::libc::c_char)
     -> ::libc::c_int;
    pub fn _reallocf_r(arg1: *mut Struct__reent, arg2: *mut ::libc::c_void,
                       arg3: size_t) -> *mut ::libc::c_void;
    pub fn setenv(__string: *const ::libc::c_char,
                  __value: *const ::libc::c_char, __overwrite: ::libc::c_int)
     -> ::libc::c_int;
    pub fn _setenv_r(arg1: *mut Struct__reent,
                     __string: *const ::libc::c_char,
                     __value: *const ::libc::c_char,
                     __overwrite: ::libc::c_int) -> ::libc::c_int;
    pub fn gcvt(arg1: ::libc::c_double, arg2: ::libc::c_int,
                arg3: *mut ::libc::c_char) -> *mut ::libc::c_char;
    pub fn gcvtf(arg1: ::libc::c_float, arg2: ::libc::c_int,
                 arg3: *mut ::libc::c_char) -> *mut ::libc::c_char;
    pub fn fcvt(arg1: ::libc::c_double, arg2: ::libc::c_int,
                arg3: *mut ::libc::c_int, arg4: *mut ::libc::c_int) ->
     *mut ::libc::c_char;
    pub fn fcvtf(arg1: ::libc::c_float, arg2: ::libc::c_int,
                 arg3: *mut ::libc::c_int, arg4: *mut ::libc::c_int) ->
     *mut ::libc::c_char;
    pub fn ecvt(arg1: ::libc::c_double, arg2: ::libc::c_int,
                arg3: *mut ::libc::c_int, arg4: *mut ::libc::c_int) ->
     *mut ::libc::c_char;
    pub fn ecvtbuf(arg1: ::libc::c_double, arg2: ::libc::c_int,
                   arg3: *mut ::libc::c_int, arg4: *mut ::libc::c_int,
                   arg5: *mut ::libc::c_char) -> *mut ::libc::c_char;
    pub fn fcvtbuf(arg1: ::libc::c_double, arg2: ::libc::c_int,
                   arg3: *mut ::libc::c_int, arg4: *mut ::libc::c_int,
                   arg5: *mut ::libc::c_char) -> *mut ::libc::c_char;
    pub fn ecvtf(arg1: ::libc::c_float, arg2: ::libc::c_int,
                 arg3: *mut ::libc::c_int, arg4: *mut ::libc::c_int) ->
     *mut ::libc::c_char;
    pub fn dtoa(arg1: ::libc::c_double, arg2: ::libc::c_int,
                arg3: ::libc::c_int, arg4: *mut ::libc::c_int,
                arg5: *mut ::libc::c_int, arg6: *mut *mut ::libc::c_char) ->
     *mut ::libc::c_char;
    pub fn rand_r(__seed: *mut ::libc::c_uint) -> ::libc::c_int;
    pub fn drand48() -> ::libc::c_double;
    pub fn _drand48_r(arg1: *mut Struct__reent) -> ::libc::c_double;
    pub fn erand48(arg1: [::libc::c_ushort, ..3u]) -> ::libc::c_double;
    pub fn _erand48_r(arg1: *mut Struct__reent,
                      arg2: [::libc::c_ushort, ..3u]) -> ::libc::c_double;
    pub fn jrand48(arg1: [::libc::c_ushort, ..3u]) -> ::libc::c_long;
    pub fn _jrand48_r(arg1: *mut Struct__reent,
                      arg2: [::libc::c_ushort, ..3u]) -> ::libc::c_long;
    pub fn lcong48(arg1: [::libc::c_ushort, ..7u]);
    pub fn _lcong48_r(arg1: *mut Struct__reent,
                      arg2: [::libc::c_ushort, ..7u]);
    pub fn lrand48() -> ::libc::c_long;
    pub fn _lrand48_r(arg1: *mut Struct__reent) -> ::libc::c_long;
    pub fn mrand48() -> ::libc::c_long;
    pub fn _mrand48_r(arg1: *mut Struct__reent) -> ::libc::c_long;
    pub fn nrand48(arg1: [::libc::c_ushort, ..3u]) -> ::libc::c_long;
    pub fn _nrand48_r(arg1: *mut Struct__reent,
                      arg2: [::libc::c_ushort, ..3u]) -> ::libc::c_long;
    pub fn seed48(arg1: [::libc::c_ushort, ..3u]) -> *mut ::libc::c_ushort;
    pub fn _seed48_r(arg1: *mut Struct__reent, arg2: [::libc::c_ushort, ..3u])
     -> *mut ::libc::c_ushort;
    pub fn srand48(arg1: ::libc::c_long);
    pub fn _srand48_r(arg1: *mut Struct__reent, arg2: ::libc::c_long);
    pub fn atoll(__nptr: *const ::libc::c_char) -> ::libc::c_longlong;
    pub fn _atoll_r(arg1: *mut Struct__reent, __nptr: *const ::libc::c_char)
     -> ::libc::c_longlong;
    ...
    pub fn strtoll(__n: *const ::libc::c_char,
                   __end_PTR: *mut *mut ::libc::c_char, __base: ::libc::c_int)
     -> ::libc::c_longlong;
    pub fn _strtoll_r(arg1: *mut Struct__reent, __n: *const ::libc::c_char,
                      __end_PTR: *mut *mut ::libc::c_char,
                      __base: ::libc::c_int) -> ::libc::c_longlong;
    pub fn strtoull(__n: *const ::libc::c_char,
                    __end_PTR: *mut *mut ::libc::c_char,
                    __base: ::libc::c_int) -> ::libc::c_ulonglong;
    pub fn _strtoull_r(arg1: *mut Struct__reent, __n: *const ::libc::c_char,
                       __end_PTR: *mut *mut ::libc::c_char,
                       __base: ::libc::c_int) -> ::libc::c_ulonglong;
    pub fn cfree(arg1: *mut ::libc::c_void);
    pub fn unsetenv(__string: *const ::libc::c_char) -> ::libc::c_int;
    pub fn _unsetenv_r(arg1: *mut Struct__reent,
                       __string: *const ::libc::c_char) -> ::libc::c_int;
    pub fn posix_memalign(arg1: *mut *mut ::libc::c_void, arg2: size_t,
                          arg3: size_t) -> ::libc::c_int;
    pub fn _dtoa_r(arg1: *mut Struct__reent, arg2: ::libc::c_double,
                   arg3: ::libc::c_int, arg4: ::libc::c_int,
                   arg5: *mut ::libc::c_int, arg6: *mut ::libc::c_int,
                   arg7: *mut *mut ::libc::c_char) -> *mut ::libc::c_char;
    pub fn _malloc_r(arg1: *mut Struct__reent, arg2: size_t) ->
     *mut ::libc::c_void;
    pub fn _calloc_r(arg1: *mut Struct__reent, arg2: size_t, arg3: size_t) ->
     *mut ::libc::c_void;
    pub fn _free_r(arg1: *mut Struct__reent, arg2: *mut ::libc::c_void);
    pub fn _realloc_r(arg1: *mut Struct__reent, arg2: *mut ::libc::c_void,
                      arg3: size_t) -> *mut ::libc::c_void;
    pub fn _mstats_r(arg1: *mut Struct__reent, arg2: *mut ::libc::c_char);
    pub fn _system_r(arg1: *mut Struct__reent, arg2: *const ::libc::c_char) ->
     ::libc::c_int;
    ...
    pub fn PP_MakeCompletionCallback(func: PP_CompletionCallback_Func,
                                     user_data: *mut ::libc::c_void) ->
     Struct_PP_CompletionCallback;
    pub fn PP_MakeOptionalCompletionCallback(func: PP_CompletionCallback_Func,
                                             user_data: *mut ::libc::c_void)
     -> Struct_PP_CompletionCallback;
    pub fn PP_RunCompletionCallback(cc: *mut Struct_PP_CompletionCallback,
                                    result: int32_t);
    pub fn PP_BlockUntilComplete() -> Struct_PP_CompletionCallback;
    pub fn PP_RunAndClearCompletionCallback(cc:
                                                *mut Struct_PP_CompletionCallback,
                                            res: int32_t);
    pub fn PP_MakeSize(w: int32_t, h: int32_t) -> Struct_PP_Size;
    pub fn PP_MakeFloatSize(w: ::libc::c_float, h: ::libc::c_float) ->
     Struct_PP_FloatSize;
    pub fn PP_MakePoint(x: int32_t, y: int32_t) -> Struct_PP_Point;
    pub fn PP_MakeFloatPoint(x: ::libc::c_float, y: ::libc::c_float) ->
     Struct_PP_FloatPoint;
    pub fn PP_MakeRectFromXYWH(x: int32_t, y: int32_t, w: int32_t, h: int32_t)
     -> Struct_PP_Rect;
    pub fn PP_MakeFloatRectFromXYWH(x: ::libc::c_float, y: ::libc::c_float,
                                    w: ::libc::c_float, h: ::libc::c_float) ->
     Struct_PP_FloatRect;
    pub fn PP_MakeTouchPoint() -> Struct_PP_TouchPoint;
    pub fn nacl_io_init();
